    ...
    <section id="contact" class="section-bg fadeInUp">
      <div class="container">
        ...
        <div class="col-md-8 explanation">
            ...
            <p class="consultation-desc mb-2">
              Hence, no two SAP ERP landscapes are exactly alike. As a result, we approach every implementation with a blank canvas and utilise experience gained and lessons learnt to generate an implementation strategy specific to the client and aligned with SAP’s Best Practices.
            </p>
            <p class="consultation-desc mb-2">
